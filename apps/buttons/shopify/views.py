...
class ButtonsShopifyBeta(URIHandler):
    ...
    def get(self, _beta):
        ...
        self.response.out.write(self.render_page('buttons/shopify/beta.html',
                                                 template_values))
...
class ButtonsShopifyLearn(URIHandler):
    ...
    def get(self):
        ...
        self.response.out.write(self.render_page('buttons/shopify/learn.html'))
...
class ButtonsShopifyWelcome(URIHandler):
    ...
    def show_upsell_page(self, shop_owner='Store Owner', shop_name='Store',
        ...
        self.response.out.write(self.render_page('buttons/shopify/upsell.html',
                                                 template_values))
...
class ButtonsShopifyPaidInstallThanks(URIHandler):
    ...
    def get(self):
        ...
        # prepopulate values
        self.response.out.write(self.render_page('buttons/shopify/install4u-instructions.html',
                                                 template_values))
...
class ButtonsShopifyInstructions(URIHandler):
    ...
    def get(self):
        ...
        self.response.out.write(self.render_page('buttons/shopify/welcome.html',
                                                 template_values))
...
class ButtonsShopifyConfig(URIHandler):
    ...
    def get(self):
        ...
        # prepopulate values
        self.response.out.write(self.render_page('buttons/shopify/config.html',
                                                 template_values))
...
class ButtonsShopifyInstallError(URIHandler):
    ...
    def get (self):
        ...
        self.response.out.write(self.render_page('buttons/shopify/install_error.html',
                                                 template_values))
        return
